    ...
    return copy.deepcopy(
        {
            ...
            "dupe_pallet_index": {"IA9999": ["IA999901"]},
        }
    )
...
@pytest.mark.parametrize(
    ...
    [
        (
            {"new-key": ["new", "new2"]},
            [{'op': 'add', 'path': '/new-key', 'value': ['new', 'new2']}],
        ),
        (
            {"custom": "foo new"},
            [{'op': 'replace', 'path': '/custom', 'value': 'foo new'}],
        ),
            ...
            [
                {
                    'op': 'add',
                    'path': '/IA9999/1',
                    'value': ['IA999901', 'IA999902', 'IA999903'],
                }
            ],
        ),
        (
...
@pytest.mark.parametrize(
    ("metadata", "source", "insert", "expected"),
    [
        ...
        ({"subject[0]": "Math"}, {"subject": "Science"}, False, {"subject": ["Math"]}),
        ...
        ({"page[0]": 42}, {"page": [1]}, False, {"page": [42]}),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"page[0]": 99}, {"page": 42}, False, {"page": [99]}),
