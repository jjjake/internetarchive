...
class TestParserReuseIsolation:
    ...
    def test_metadata_action_parser_reuse(self):
        ...
        parser.add_argument(
            "--metadata", nargs="+", action=MetadataAction, default=None
        )
    ...
    def test_query_string_action_parser_reuse(self):
        parser = argparse.ArgumentParser()
        parser.add_argument(
            "--param", nargs="+", action=QueryStringAction, default=None
        )
...
class TestQueryStringAction:
    ...
    def test_repeated_key_accumulates(self):
        ...
        parser = argparse.ArgumentParser()
        parser.add_argument("--param", nargs=1, action=QueryStringAction, default=None)
        args = parser.parse_args(["--param", "a=1", "--param", "a=2"])
...
class TestPostDataAction:
    ...
    def test_json_with_colons_in_value(self):
        ...
        parser = argparse.ArgumentParser()
        parser.add_argument("--data", nargs="+", action=PostDataAction, default=None)
